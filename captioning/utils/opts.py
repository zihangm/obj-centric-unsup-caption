...
def parse_opt():
    ...
    # sentence to multi image
    parser.add_argument('--input_vg_ix_dir', type=str, default='/mnt/m2/Datasets/COCO/COCO_feats_detectron2/vg_obj_to_coco_ix',
                        help='path to the directory containing the preprocessed vg_ix') #Unsup
    parser.add_argument('--useful_sentence_ixs', type=str,
                        default='data/coco_coco_useful_sentence_ixs.npy',
                        help='path to the directory containing the useful sentences ixs')  # Unsup
    parser.add_argument('--obj_ix_to_img_ix', type=str,
                        default='data/coco_coco_obj_ix_to_img_ix.npy',
                        help='path to the directory containing the obj_ix_to_img_ix dict')  # Unsup
    parser.add_argument('--use_UNK', type=int,
                        default=0,
                        help='Whether the last token in vocab is UNK')  # Unsup
    # scene graph
    parser.add_argument('--input_vg_triplet_dir', type=str, default='',
                        help='path to the directory containing the triplets from scene graph') # Unsup
    parser.add_argument('--triplet_ix_to_img_ix', type=str, default='',
                        help='path to the directory containing the triplet_ix_to_img_ix dict')  # Unsup
    parser.add_argument('--attr_ix_to_img_ix', type=str, default='',
                        help='path to the directory containing the triplet_ix_to_img_ix dict')  # Unsup
    ...
    parser.add_argument('--img_ix_to_sentence_ix', type=str, default='data/coco_unpaired_img_ix_to_sent_ix.npy',
                        help='path to the npy containing the preprocessed dataset') #Unsup: for sampling img-caption pairs
    parser.add_argument('--no_pair_img_ixs', type=str, default='',
                        help='path to the npy containing the img ixs with no pair')  # Unsup: for sampling img-caption pairs
    ...
    parser.add_argument('--debug', type=int, default=0,
                        help='whether it is in debug mod (directly enter evaluation)')
    ...
    args.checkpoint_path = args.checkpoint_path or './saved_model/log_%s' %args.id
...
def add_eval_options(parser):
    ...
    parser.add_argument('--input_att_dir', type=str, default='',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_vg_ix_dir', type=str, default='',
                        help='path to the h5file containing the preprocessed dataset')
